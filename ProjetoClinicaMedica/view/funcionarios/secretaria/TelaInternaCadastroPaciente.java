...
private JButton btnCadastrar;
	...
	public TelaInternaCadastroPaciente() {
		...
		getContentPane().setLayout(new MigLayout("", "[][pref!,grow][grow][grow][grow][grow][pref!,grow][grow][grow][grow]", "[38,grow][38,grow][31px,grow][38px,grow][38,grow][38,grow][38,grow][38,grow][38,grow][38px,grow][38,grow][38,grow][38,grow][38,grow][38,grow][36px][38,grow][38,grow][38,grow][38,grow][38,grow][38,grow]"));
		initialize();
	}
	...
	private void initialize() {
		...
		getContentPane().add(cbConvenio, "cell 2 7,grow");

		
		dateChooser = new JDateChooser();
		getContentPane().add(dateChooser, "cell 2 4,grow");
		

		btnCadastrar = new JButton("Cadastrar");
		getContentPane().add(btnCadastrar, "cell 3 20 2 1,grow");
		btnCadastrar.addActionListener(e -> {

		});

		btnLimpar = new JButton("Limpar Campos");
		getContentPane().add(btnLimpar, "cell 5 20,grow");
