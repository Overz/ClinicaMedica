...
private JButton btnCadastrar;
	...
	public TelaInternaCadastroPaciente() {
		...
		getContentPane().setLayout(new MigLayout("", "[][pref!,grow][grow][grow][grow][grow][pref!,grow][grow][grow][grow]", "[38,grow][38,grow][31px,grow][38px,grow][38,grow][38,grow][38,grow][38,grow][38,grow][38,grow][38px,grow][38,grow][38,grow][38,grow][38,grow][38,grow][36px][38,grow][38,grow][38,grow][38,grow][38,grow][38,grow]"));
		initialize();
	}
	...
	private void initialize() {
		...
		getContentPane().add(lblTipoSanguineo, "cell 5 6,alignx center,growy");
		...
		getContentPane().add(endereco, "cell 1 10 8 1,alignx center,growy");

		JLabel lblCidade = new JLabel("Cidade:");
		lblCidade.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblCidade, "cell 1 12,alignx left,aligny center");

		JLabel lblBairro = new JLabel("Bairro:");
		lblBairro.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblBairro, "cell 1 13,growx,aligny center");

		JLabel lblNumero = new JLabel("Numero:");
		lblNumero.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblNumero, "cell 5 13,alignx center,growy");

		JLabel lblComplemento = new JLabel("Complemento:");
		lblComplemento.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblComplemento, "cell 1 14,growx,aligny center");
		
		JLabel lblContato = new JLabel("Contato");
		lblContato.setFont(new Font("Verdana", Font.BOLD, 14));
		getContentPane().add(lblContato, "cell 1 16 8 1,alignx center,growy");

		JLabel lblNumeroTelefone = new JLabel("Telefone:");
		lblNumeroTelefone.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblNumeroTelefone, "cell 1 18,growx,aligny center");
		
		JLabel lblEmail = new JLabel("E-Mail:");
		lblEmail.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblEmail, "cell 5 18,alignx center,growy");
		
		JLabel lblCelular = new JLabel("Celular:");
		lblCelular.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblCelular, "cell 1 19,alignx left,growy");
		
		JLabel lblRua = new JLabel("Rua:");
		lblRua.setFont(new Font("Verdana", Font.PLAIN, 14));
		getContentPane().add(lblRua, "cell 5 12,alignx center,growy");
		
		txtCidade = new JTextField();
		txtCidade.setColumns(10);
		getContentPane().add(txtCidade, "cell 2 12,grow");
		
		txtEmail = new JTextField();
		getContentPane().add(txtEmail, "cell 6 18 3 1,grow");
		txtEmail.setColumns(10);
		
		txtRuaEndereco = new JTextField();
		getContentPane().add(txtRuaEndereco, "cell 6 12 3 1,grow");
		txtRuaEndereco.setColumns(10);

		
		txtBairroEndereco = new JTextField();
		getContentPane().add(txtBairroEndereco, "cell 2 13,grow");
		txtBairroEndereco.setColumns(10);

		txtNumeroEndereco = new JTextField();
		getContentPane().add(txtNumeroEndereco, "cell 6 13,grow");
		txtNumeroEndereco.setColumns(10);
		
		txtComplementoEndereco = new JTextField();
		getContentPane().add(txtComplementoEndereco, "cell 2 14,grow");
		...
		getContentPane().add(ftfTelefone, "cell 2 18,grow");
		
		ftfCelular = new JFormattedTextField(mascaraTelefone);
		getContentPane().add(ftfCelular, "cell 2 19,grow");
		...
		getContentPane().add(cbTipoSanguineo, "cell 6 6,grow");
		...
		getContentPane().add(dateChooser, "cell 2 5,grow");
		

		btnCadastrar = new JButton("Cadastrar");
		getContentPane().add(btnCadastrar, "cell 3 21 2 1,grow");
		btnCadastrar.addActionListener(e -> {

		});

		btnLimpar = new JButton("Limpar Campos");
		getContentPane().add(btnLimpar, "cell 5 21,grow");
