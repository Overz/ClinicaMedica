...
public class TelaInternaCadastrarAtualizarPaciente extends JInternalFrame {
	...
	public TelaInternaCadastrarAtualizarPaciente() {
		...
		// BasicInternalFrameUI ui = (BasicInternalFrameUI) new
		// TelaInternaAtualizarCliente().getUI();
		...
		getContentPane()
				.setLayout(new MigLayout("", "[60.00px][grow][grow][79px]", "[29.00px][29.00][40.00][grow][fill]"));
		initialize();
	}
